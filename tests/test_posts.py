...
def test_get_all_posts(authorized_client, test_posts):
    ...
    # posts_list order will not be same as test_posts
...
@pytest.mark.parametrize("title, content, published", [
    ('rand title 1', 'rand content 1', True),
    ('rand title 2', 'rand content 2', False),
    ('rand title 3', 'rand content 3', True),
])
...
def test_unauthorized_update_user_post(client, test_posts):
    data = {
        "title": "updated title",
        "content": "updated content",
        "id": test_posts[3].id
